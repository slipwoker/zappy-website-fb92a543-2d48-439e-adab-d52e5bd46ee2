document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      // If form has data-ajax attribute, handle via fetch
      if (contactForm.dataset.ajax !== undefined) {
        ...
        fetch(action, {
          ...
          .catch(function () {
            const errorDiv = contactForm.querySelector('.form-submit-error') || document.createElement('div');
            errorDiv.className = 'form-submit-error';
            errorDiv.setAttribute('role', 'alert');
            errorDiv.textContent = contactForm.dataset.errorMessage || 'Something went wrong. Please try again.';
            if (!contactForm.querySelector('.form-submit-error')) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "טסים על זה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'fb92a543-2d48-439e-adab-d52e5bd46ee2',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'fb92a543-2d48-439e-adab-d52e5bd46ee2';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'fb92a543-2d48-439e-adab-d52e5bd46ee2';
